...
random.seed(7)#random seed for reproducible results
...
"""
The method above randomly samples taxa till the average converges to a 0.1% difference from the actual value. 
